---
description: Write a feature specification — what to build, for whom, and how success is measured. Use when starting a new feature, specifying requirements and success criteria, or capturing what a feature must do before any planning — not project-wide rules (/spectastic.principles), the how (/spectastic.design), or throwaway learning (/spectastic.explore).
